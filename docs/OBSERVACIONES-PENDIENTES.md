...
O. **EN PLAN** (respuesta legal y respuestas de Santiago recibidas el 2026-09-21; plan de sesiones en `docs/PLAN_IMPORTACION_DESDE_EL_HTML.md`; sesión 1 HECHA el 2026-09-22: la regla del enlace, el consentimiento de origen HTML (0159) y su texto archivado) Poder exportar pacientes del html e importarlos a atlas web sin importar que hayan diferencias de preguntas y calculos, es decir, que solo importariamos a Atlas las respuestas de la encuesta, observaciones, notas, y revisar que mas podemos importar para que los pacientes que ya han trabajado mucho con el html, no pierdan sus pacientes al momento de migrar a Atlas web.
---
...
| **g** | Las alertas de la encuesta van en el **segundo párrafo** del resumen de IA (prompt v5, migración 0151) y como **primera línea de la A** del SOAP, de la MISMA fuente (`alertasDeLaConsulta`): las reglas de Gildardo que pueden correr y las respuestas en **rojo** de su clasificador del v9. El ámbar y la composición no entran; sin duplicados. La S sigue sin semáforo. Candado: `alertas-de-la-consulta.test.ts` |
