...
salieron de verificar tu archivo, **cinco preguntas** y **cuatro puntos que se te pasaron**.
...
# 8 · El 8.5 y el 3.5: te mandamos el mapa, no el repositorio
...
| 8 | Te mandamos **el mapa**, no el repositorio | Nada |
