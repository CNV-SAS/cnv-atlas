...
- **Nota para su aprobación (efecto de rango ancho, verificado 2026-08-01):** la regla del promedio hace que un rango ANCHO produzca Δ grandes en los bordes aunque el valor esté DENTRO de rango. Caso: **FFMI (17–25)**: un FFMI en el borde (17 o 25), clínicamente normal, muestra Δ ∓4; un paciente normal-pero-limítrofe vería "−4"/"+4", que puede leerse alarmante sin serlo. **IAE (−5 a +5)**: ±5 en el borde. AF (rango 0.5) y los de corte único no tienen el efecto. No es un error (es su regla); se señala para que lo considere al aprobar. El donante golden no lo exhibe (su FFMI 21.1 cae en el promedio).
