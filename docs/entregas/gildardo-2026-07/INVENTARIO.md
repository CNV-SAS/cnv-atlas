...
| Pendiente (tercer archivo) | por crear: `docs/entregas/gildardo-YYYY-MM-DD/` (nombre original preservado) | por medir al llegar | — (aún nada portado de él) | `Decisiones_ANI-BIS-E_2026-07-29` (líneas 14077, 14088, 6529, 12828, etc.). NO portar hasta que la prueba de identidad de esas líneas pase (regla 17, paso 3) |
