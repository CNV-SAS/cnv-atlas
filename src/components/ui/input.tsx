...
// texto corrido: Gildardo no encontro donde pulsar. Va en `secondary` y no en `primary` a proposito, para
// no competir con el boton de enviar que suele estar justo debajo, y con `cursor-pointer`, que era la otra
// mitad de lo que faltaba: sin el, nada indica que eso se pulsa.
//
