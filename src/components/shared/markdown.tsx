...
// Render de markdown reutilizable (consentimiento, "ver mas" de la encuesta, menu de IA).
// Client component: react-markdown corre en cliente sin ambiguedad. No usa
// dangerouslySetInnerHTML y react-markdown no interpreta HTML crudo por defecto
// (SECURITY.md). El proyecto no tiene plugin de tipografia, asi que cada elemento se
// estiliza explicitamente.
const components: Components = {
  h1: ({ children }) => <h1 className="mt-6 text-xl font-bold text-foreground">{children}</h1>,
