// Texto canonico del consentimiento informado de ATLAS, version 1.5.
//
...
// este archivo es su materializacion verificable para el hash. Generado desde el
// doc con scripts/generate-consent-v1.5.mjs (uso unico), no transcrito a mano.
//
...
// version (1.5 -> 1.6) y se regenera este archivo desde CONSENT_ATLAS.md.

export const CONSENT_VERSION = "1.5";

export const CONSENT_TEXT_V1_5 = `## 1. ¿Por qué este formulario?
