...
const EXPLICACION: Record<VentaPorRevisar["motivo"], string> = {
  pago_sobre_link_anulado:
    "El paciente pagó con Wompi un link que Atlas ya había anulado, casi siempre porque también pagó en efectivo. No se factura, no se descuenta y no se entrega hasta decidir. Si fue un cobro doble, devuelve el pago desde Wompi y márcalo como devuelto; si el paciente quería las dos compras, márcala como segunda compra y Atlas descuenta y factura.",
  sin_saldo:
...
export function VentasPorRevisar({ ventas }: { ventas: VentaPorRevisar[] }) {
  return (
