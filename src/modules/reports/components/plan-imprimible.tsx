    ...
    <div className={bloqueCls("derivado")}>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-col items-end gap-2">
          {/* IMPRIMIR REGISTRA LA ENTREGA (2026-09-09). Aqui habia DOS botones: este y "Entregado en
              consulta", que sellaba la prescripcion y la cerraba. Santiago lo reporto como confuso y
              tenia razon: eran dos gestos para un solo acto, y el segundo ademas bloqueaba. Ahora el
              registro va donde ya estaba el gesto. */}
          <PlanImprimirBoton evaluationId={evaluationId} />
        </div>
      </div>
      ...
      <div className="solo-impresion imprimible flex-col gap-5">
        ...
        {/* LA BANDA DE BORRADOR SE RETIRO (2026-09-09), y se explica aqui porque la pidio Santiago hace
            ...
            Decia "esta prescripción todavía no está aprobada y puede cambiar", y distinguia DOS estados:
            aprobada y borrador. Ese par ya no existe: la prescripcion esta SIEMPRE abierta, asi que la
            banda pasaria de ser una advertencia a ser una verdad universal impresa en todas las hojas,
            que es ruido. Lo que la banda protegia (que el paciente no se lleve un papel que nadie asume)
            lo resuelve mejor la EMISION: imprimir registra la entrega, y la historia clinica dice que
            salio y cuando. */}
